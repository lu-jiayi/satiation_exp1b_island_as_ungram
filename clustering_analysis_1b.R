...
results
 ...
 plot(all_vec[c("wh_intercept", "wh_slope")], col = results$cluster)
 plot(all_vec[c("subj_intercept", "subj_slope")], col = results$cluster)
 plot(all_vec[c("wh_intercept", "wh_slope", "cnpc_intercept", "cnpc_slope", "subj_intercept", "subj_slope")])
